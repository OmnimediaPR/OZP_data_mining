...
DATASETS = {
    ...
    "sluch_screening_pokryti": {
        "label": "Screening sluchu — pokrytí novorozenců",
        "human_name": "Pokrytí novorozenců screeningem sluchu",
        "description": "Procento dětí, které absolvovaly preventivní screening sluchu do věku 5 let. Včasné odhalení vady sluchu umožňuje včasnou intervenci (sluchadla, kochleární implantát) a normální vývoj řeči.",
        "code": "screening sluchu",
        "source": "Informační systém screeningu sluchu u novorozenců (ÚZIS)",
        "source_type": "national",
        "metric": "pokryti_pct",
        "metric_label": "Pokrytí populace (%)",
        "relevant_for": ["dětské zdraví", "prevence", "ORL", "vývoj řeči"],
        "trend_context": "Včasný záchyt vady sluchu zásadně mění vývoj dítěte — bez intervence dochází k opoždění řeči. Klíčový pediatrický screeningový program.",
        "data_url": "https://datanzis.uzis.gov.cz/data/PPS-06-SLUCH/PPS-06-02/Otevrena-data-PPS-06-02-sluch-screening-pokryti-populace.csv",
        "source_url": "https://www.nzip.cz/data/2619-sluch-screening-5-let-pokryti-populace-otevrena-data",
        "year_col": "rok",
        "agg_func": "ratio",
        "numerator_col": "pocet_vysetrenych",
        "denominator_col": "populace",
    },
    "cervix_cytologie_pocet": {
        "label": "Cervikovaginální cytologie — počet provedených",
        "human_name": "Počet provedených cervikovaginálních cytologií",
        "description": "Roční počet provedených cytologických vyšetření hrdla děložního v rámci screeningu rakoviny děložního čípku. Primární screeningový nástroj.",
        "code": "screening C53",
        "source": "Informační systém screeningu karcinomu hrdla děložního (ÚZIS)",
        "source_type": "national",
        "metric": "vysetreni_rocni",
        "metric_label": "Roční počet vyšetření",
        "relevant_for": ["screening", "ženské zdraví", "prevence"],
        "trend_context": "Vývoj odráží aktivní zvaní pojišťovnami a osvětu o významu preventivních gynekologických prohlídek.",
        "data_url": "https://data.mzcr.cz/data/distribuce/400/Otevrena-data-PPS-03-03-cervix-cytologie-pocet.csv",
        "source_url": "https://www.nzip.cz/data/2095-cervix-cytologie-pocet-otevrena-data",
        "year_col": "rok",
        "metric_col": "pocet_vysetreni",
        "agg_func": "sum",
    },
    "cervix_cytologie_abnormalni_podil": {
        "label": "Cervikální cytologie — podíl abnormálních výsledků",
        "human_name": "Podíl abnormálních cytologií čípku",
        "description": "Procento žen s abnormálním výsledkem cytologického vyšetření hrdla děložního. Stabilní podíl ukazuje zdravou statistiku screeningu — výrazné výkyvy by indikovaly problém.",
        "code": "screening C53",
        "source": "Informační systém screeningu karcinomu hrdla děložního (ÚZIS)",
        "source_type": "national",
        "metric": "abnormalni_pct",
        "metric_label": "Podíl abnormálních (%)",
        "relevant_for": ["screening", "ženské zdraví", "prevence", "lidský papilomavirus"],
        "trend_context": "Stabilita podílu abnormálních cytologií indikuje konzistentní kvalitu screeningu. Postupný pokles po zavedení očkování proti lidskému papilomaviru je očekávaný dlouhodobý efekt.",
        "data_url": "https://data.mzcr.cz/data/distribuce/399/Otevrena-data-PPS-03-02-cervix-cytologie-podil-abnormalnich.csv",
        "source_url": "https://www.nzip.cz/data/2094-cervix-cytologie-podil-abnormalnich-otevrena-data",
        "year_col": "rok",
        "agg_func": "ratio",
        "numerator_col": "pocet_abnormalnich",
        "denominator_col": "pocet_vysetrenych",
    },
    "kolonoskopie_screening_pocet": {
        "label": "Screeningové kolonoskopie — počet provedených",
        "human_name": "Počet provedených screeningových kolonoskopií",
        "description": "Roční počet kolonoskopií provedených v rámci screeningu rakoviny tlustého střeva — buď jako primární vyšetření, nebo navazující po pozitivním testu na skryté krvácení.",
        "code": "screening C18–C20",
        "source": "Informační systém screeningu karcinomu tlustého střeva a konečníku (ÚZIS)",
        "source_type": "national",
        "metric": "vysetreni_rocni",
        "metric_label": "Roční počet kolonoskopií",
        "relevant_for": ["screening tlustého střeva", "prevence", "gastroenterologie"],
        "trend_context": "Vývoj odráží rozšíření primární screeningové kolonoskopie (od 2009) a aktivní zvaní pojišťovnami. Dostupnost kolonoskopických center se mezi kraji liší.",
        "data_url": "https://data.mzcr.cz/data/distribuce/397/Otevrena-data-PPS-02-04-kolorektum-screeningove-kolonoskopie-pocet.csv",
        "source_url": "https://www.nzip.cz/data/2092-kolorektum-screeningove-kolonoskopie-pocet-otevrena-data",
        "year_col": "rok",
        "metric_col": "pocet_vysetreni",
        "agg_func": "sum",
    },
    "toks_pocet": {
        "label": "Test na skryté krvácení do stolice — počet provedených",
        "human_name": "Počet provedených testů na skryté krvácení",
        "description": "Roční počet testů na skryté krvácení do stolice provedených v rámci screeningu rakoviny tlustého střeva. Primární screeningový nástroj — pozitivní výsledek vyžaduje navazující kolonoskopii.",
        "code": "screening C18–C20",
        "source": "Informační systém screeningu karcinomu tlustého střeva a konečníku (ÚZIS)",
        "source_type": "national",
        "metric": "vysetreni_rocni",
        "metric_label": "Roční počet testů",
        "relevant_for": ["screening tlustého střeva", "prevence", "primární péče"],
        "trend_context": "Vývoj odráží aktivní zvaní pojišťovnami a dostupnost testu (provádí praktický lékař nebo gynekolog). Drtivá většina screeningu rakoviny tlustého střeva začíná tímto testem.",
        "data_url": "https://data.mzcr.cz/data/distribuce/395/Otevrena-data-PPS-02-03-kolorektum-toks-pocet.csv",
        "source_url": "https://www.nzip.cz/data/2091-kolorektum-toks-pocet-otevrena-data",
        "year_col": "rok",
        "metric_col": "pocet_vysetreni",
        "agg_func": "sum",
    },
    "mamografie_pocet": {
        "label": "Screeningové mamografie — počet provedených",
        "human_name": "Počet provedených screeningových mamografií",
        "description": "Roční počet mamografií provedených v rámci screeningu rakoviny prsu u žen od 45 let.",
        "code": "screening C50",
        "source": "Informační systém screeningu karcinomu prsu (ÚZIS)",
        "source_type": "national",
        "metric": "vysetreni_rocni",
        "metric_label": "Roční počet mamografií",
        "relevant_for": ["screening", "ženské zdraví", "prevence"],
        "trend_context": "Vývoj odráží stárnutí populace (víc žen v cílové věkové skupině), aktivní zvaní pojišťovnami a dostupnost mamografických center.",
        "data_url": "https://data.mzcr.cz/data/distribuce/392/Otevrena-data-PPS-01-02-mamografie-screeningova-vysetreni-pocet.csv",
        "source_url": "https://www.nzip.cz/data/2088-mamografie-screeningova-vysetreni-pocet-otevrena-data",
        "year_col": "rok",
        "metric_col": "pocet_vysetreni",
        "agg_func": "sum",
    },
    "mamografie_doplnujici_podil": {
        "label": "Mamografie — podíl žen s doplňujícím vyšetřením",
        "human_name": "Podíl žen s doplňujícím vyšetřením po mamografii",
        "description": "Procento žen, které po screeningové mamografii potřebovaly doplňující vyšetření (například cílenou mamografii nebo ultrazvuk). Ukazatel přesnosti primárního screeningu.",
        "code": "screening C50",
        "source": "Informační systém screeningu karcinomu prsu (ÚZIS)",
        "source_type": "national",
        "metric": "doplnujici_pct",
        "metric_label": "Podíl s doplňujícím vyšetřením (%)",
        "relevant_for": ["screening", "ženské zdraví", "kvalita screeningu"],
        "trend_context": "Nižší podíl doplňujících vyšetření znamená lepší přesnost primární mamografie a menší zátěž pro pacientky. Evropská doporučení považují podíl 5-7 % za optimální.",
        "data_url": "https://data.mzcr.cz/data/distribuce/437/Otevrena-data-PPS-01-05-mamografie-doplnujici-vysetreni.csv",
        "source_url": "https://www.nzip.cz/data/2325-mamografie-doplnujici-vysetreni-otevrena-data",
        "year_col": "rok",
        "agg_func": "ratio",
        "numerator_col": "pocet_vysetreni_doplnujici",
        "denominator_col": "pocet_vysetreni",
    },
    "mamografie_uz_podil": {
        "label": "Mamografie — podíl žen s doplňujícím ultrazvukem",
        "human_name": "Podíl žen s doplňujícím ultrazvukem po mamografii",
        "description": "Procento žen, které po screeningové mamografii podstoupily doplňující ultrazvukové vyšetření prsu. Doplňující ultrazvuk se používá zejména u žen s denzním prsem, kde mamografie sama nemusí stačit.",
        "code": "screening C50",
        "source": "Informační systém screeningu karcinomu prsu (ÚZIS)",
        "source_type": "national",
        "metric": "uz_pct",
        "metric_label": "Podíl s ultrazvukem (%)",
        "relevant_for": ["screening", "ženské zdraví", "kvalita screeningu"],
        "trend_context": "Doplňující ultrazvuk zvyšuje záchyt rakoviny u žen s denzním prsem, ale také zvyšuje počet falešně pozitivních výsledků. Indikace má být individuální.",
        "data_url": "https://data.mzcr.cz/data/distribuce/393/Otevrena-data-PPS-01-03-Mamografie-ultrazvukova-vystreni-podil-2024-01.csv",
        "source_url": "https://www.nzip.cz/data/2089-mamografie-ultrazvukova-vysetreni-podil-otevrena-data",
        "year_col": "rok",
        "agg_func": "ratio",
        "numerator_col": "pocet_uz",
        "denominator_col": "pocet_mamografii",
    },
    "paliativni_trajektorie_optimalni": {
        "label": "Paliativní péče — podíl optimálních trajektorií",
        "human_name": "Podíl pacientů s optimální trajektorií před úmrtím",
        "description": "Procento pacientů s očekávatelným úmrtím, kteří měli optimální trajektorii péče v posledních měsících života (např. paliativní péče doma, kvalitní symptomatická léčba). Klíčový ukazatel kvality paliativní péče.",
        "code": "paliativní péče",
        "source": "Národní informační systém paliativní péče (ÚZIS)",
        "source_type": "national",
        "metric": "optimalni_pct",
        "metric_label": "Podíl optimálních trajektorií (%)",
        "relevant_for": ["paliativní péče", "kvalita umírání", "hospice"],
        "trend_context": "Optimální trajektorie = pacient v posledních týdnech života v péči paliativního týmu, ne na intenzivní péči. Vývoj odráží postupný rozvoj paliativní péče v ČR.",
        "data_url": "https://datanzis.uzis.gov.cz/data/OIS-05-NISPP/OIS-05-04/Otevrena-data-OIS-05-04-trajektorie-pacientu-pred-umrtim-regiony.csv",
        "source_url": "https://www.nzip.cz/data/2661-trajektorie-pacientu-pred-umrtim-regiony-otevrena-data",
        "year_col": "rok_umrti",
        "agg_func": "ratio",
        "numerator_col": "optimalni_trajektorie",
        "denominator_col": "pocet_ocekavatelne_zemrelych",
    },
