...
const CONFIGS = [
  ...
  {
    id: 'novorozenci_pece_sal', src: 'https://data.mzcr.cz/data/distribuce/343/novorozenci-pece-sal.csv',
    source: 'Národní registr reprodukčního zdraví (ÚZIS ČR)', source_url: 'https://www.nzip.cz/data/1705-novorozenci-pece-porodni-sal-otevrena-data',
    human_name: 'Novorozenci — péče na porodním sále',
    description: 'Počty novorozenců, u nichž byla na porodním sále poskytnuta daná podpůrná péče (časné přiložení k prsu, kontakt kůže na kůži neboli bonding, odložený podvaz pupečníku), rozpadnutelné podle gestačního stáří, věku matky a typu poskytovatele. U jednoho novorozence může být poskytnuto víc typů péče, počty napříč nimi proto nelze sčítat.',
    metric_label: 'Novorozenci s danou péčí', metric: { type: 'wide' }, yearCol: 'rok_narozeni', year_from: 2000, noAnomalies: true,
    note: 'Příznakové sloupce péče (hodnota 1 = poskytnuta). Tyto údaje registr sbírá teprve od roku 2022, kostka proto obsahuje zatím jen jeden rok — jde o snímek stavu, ne časovou řadu. U jednoho novorozence může být poskytnuto víc typů péče → počty napříč nimi nelze sčítat. Názvy odvozené z metodiky registru.',
    wideCauses: [
      { col: 'pece_casneprilozeni', name: 'časné přiložení k prsu' },
      { col: 'pece_bonding', name: 'kontakt kůže na kůži (bonding)' },
      { col: 'pece_odlozenypodvaz', name: 'odložený podvaz pupečníku' },
    ],
    dims: [
      { key: 'pece', label: 'Typ péče', kind: 'category', primary: true, wide: true },
      { key: 'gestace', label: 'Gestační stáří', kind: 'category', col: 'gestacni_stari', order: 'fixed',
  ...
  {
    id: 'novorozenci_propusteni', src: 'https://data.mzcr.cz/data/distribuce/313/novorozenci-propusteni.csv',
    source: 'Národní registr reprodukčního zdraví (ÚZIS ČR)', source_url: 'https://www.nzip.cz/data/1611-novorozenci-propusteni-otevrena-data',
    human_name: 'Novorozenci — výživa a propuštění',
    description: 'Interaktivní rozpad živě narozených dětí podle způsobu výživy při propuštění (výlučné kojení, dokrm formulí, umělá výživa, parenterální výživa), délky hospitalizace, důvodu ukončení péče (propuštění domů, překlad, úmrtí), způsobu porodu a gestačního stáří. Ukazuje mimo jiné podíl výlučně kojených dětí a délku pobytu po porodu.',
    metric_label: 'Živě narozené děti', metric: { type: 'count' }, yearCol: 'rok_narozeni', year_from: 2000, noAnomalies: true,
    note: 'Jedna řádka = jedno živě narozené dítě, registr eviduje od roku 2000. Údaje jsou počítány z poslední zprávy o novorozenci (bez rehospitalizací). Číselník způsobu výživy byl v čase rozšiřován, podíly jednotlivých kategorií proto nelze srovnávat napříč celou řadou bez výhrad. Kategorie „nezjištěno"/„neuvedeno" jsou ponechány, aby součty seděly.',
    dims: [
      { key: 'vyziva', label: 'Výživa při propuštění', kind: 'category', primary: true, col: 'propusteni_vyziva', order: 'fixed',
        fixed: ['výlučné kojení', 'dokrm formulí', 'formule (umělá výživa)', 'parenterální výživa', 'úmrtí po porodu', 'neuvedeno'],
        valueMap: { '1': 'výlučné kojení', '2': 'dokrm formulí', '3': 'formule (umělá výživa)', '4': 'parenterální výživa', '5': 'úmrtí po porodu', '0': 'neuvedeno', '': 'neuvedeno' } },
      { key: 'delka', label: 'Délka hospitalizace', kind: 'category', col: 'delka_zivota_prop', order: 'fixed',
        fixed: ['0 dní', '1 den', '2 dny', '3 dny', '4 dny', '5 dní', '6 dní', '7–13 dní', '14 dní a více', 'nezjištěno'],
        valueMap: { '0': '0 dní', '1': '1 den', '2': '2 dny', '3': '3 dny', '4': '4 dny', '5': '5 dní', '6': '6 dní', '7': '7–13 dní', '8': '14 dní a více', '': 'nezjištěno' } },
      { key: 'duvod', label: 'Důvod ukončení péče', kind: 'category', col: 'propusteni_duvod', order: 'fixed',
        fixed: ['propuštění domů', 'překlad do léčebného zařízení', 'překlad do dětského domova', 'úmrtí', 'dovršení 3 měsíců věku', 'neuvedeno'],
        valueMap: { '1': 'propuštění domů', '2': 'překlad do léčebného zařízení', '3': 'překlad do dětského domova', '4': 'úmrtí', '5': 'dovršení 3 měsíců věku', '0': 'neuvedeno', '': 'neuvedeno' } },
      { key: 'zpusob', label: 'Způsob porodu', kind: 'category', col: 'zpusob_porodu', order: 'fixed',
        fixed: ['vaginální porod', 'císařský řez', 'nezjištěno'],
        valueMap: { '1': 'vaginální porod', '2': 'císařský řez', '': 'nezjištěno' } },
      { key: 'gestace', label: 'Gestační stáří', kind: 'category', col: 'gestacni_stari', order: 'fixed',
        fixed: ['do 31. týdne', '32.–36. týden', '37.–38. týden', '39. týden a více', 'nezjištěno'],
        valueMap: { '1': 'do 31. týdne', '2': '32.–36. týden', '3': '37.–38. týden', '4': '39. týden a více', '': 'nezjištěno' } },
    ],
